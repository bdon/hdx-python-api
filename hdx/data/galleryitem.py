...
class GalleryItem(HDXObject):
    ...
    def update_from_yaml(self, path= join('config', 'hdx_galleryitem_static.yml')):# -> None:
    ...
    def update_from_json(self, path = join('config', 'hdx_galleryitem_static.json')):# -> None:
    ...
    @staticmethod
    def read_from_hdx(identifier):# -> Optional['GalleryItem']:
