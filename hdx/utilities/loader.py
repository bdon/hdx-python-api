...
def load_and_merge_yaml(paths):# -> dict:
...
def load_and_merge_json(paths):# -> dict:
...
def load_yaml_into_existing_dict(data, path):# -> dict:
...
def load_json_into_existing_dict(data, path):# -> dict:
